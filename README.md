...
AI tools were employed for assisstance and to support my understanding of specific coding scripts, particularly those related to statistical methods such as t-tests, probability and RFM clustering. AI was in the driver’s seat throughout this process generating code, guiding the analytical workflow and offering step-by-step explanations. This enhanced my conceptual knowledge and provided clarity on the practical implementation of these techniques within the analytical process.
